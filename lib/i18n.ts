...
export const STRINGS = {
  en: {
    ...
    heroTitle1: 'From your first line of code to ',
    heroTitle2: 'your first job.',
    heroSub: 'Design, development, deployment, and the career skills that come after — all free, with runnable examples, in English and Bengali.',
  ...
  bn: {
    ...
    heroTitle1: 'প্রথম কোড থেকে ',
    heroTitle2: 'প্রথম চাকরি পর্যন্ত।',
    heroSub: 'ডিজাইন, ডেভেলপমেন্ট, ডিপ্লয়মেন্ট, আর তারপরের ক্যারিয়ার স্কিল — সবটাই ফ্রি, রান করার মতো উদাহরণসহ, বাংলা ও ইংরেজিতে।',
    ...
    menu: 'মেনু',
    interactiveTool: 'ইন্টারঅ্যাক্টিভ টুল',
  },
