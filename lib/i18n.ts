...
export const STRINGS = {
  en: {
    ...
    heroSub: 'Lessons on HTML, CSS, JavaScript, React, and graphic design — with runnable examples, for absolutely anyone.',
  ...
  bn: {
    ...
    heroSub: 'HTML, CSS, JavaScript, React এবং গ্রাফিক ডিজাইনের পাঠ — রান করার মতো উদাহরণসহ, সবার জন্য।',
