...
| **`docs/CONTENT-PIPELINE.md`** | **the runbook for adding new lessons** — topic → written → illustrated → bilingual → published. Follow it whenever asked to write content | the pipeline's defaults change |
