...
sort_order: 9
updated_at: "2026-08-18T03:18:17.34688+00:00"
---
...
[
  ...
  {
    "id": "4DMEk3W6E9KQ",
    "alt": "A classic devtools-style diagram of the CSS box model, showing nested margin, border, padding, and content regions, each labeled",
    "type": "image",
    "width": 1188,
    "height": 662,
    "caption": "The CSS box model, outside in: margin, then border, then padding, then the actual content.",
    "publicId": "docs/img/css/box-model-diagram"
  },
  {
    "id": "9r4KhBtmz-hH",
