...
sort_order: 19
updated_at: "2026-08-18T03:18:17.665655+00:00"
---
...
[
  ...
  {
    "id": "kX2J9op-78Er",
    "alt": "Five labeled comparison panels showing the effect of each CSS position value: static, relative, absolute, fixed, and sticky",
    "type": "image",
    "width": 1286,
    "height": 428,
    "caption": "The five position values side by side — what each one actually does to an element.",
    "publicId": "docs/img/css/position-values"
  },
  {
    "id": "vrh4AKRCJhPK",
